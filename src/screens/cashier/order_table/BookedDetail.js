    ...
    <KeyboardAvoidingView style={styles.container} behavior='padding'>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.input}>{preorderDetail.name}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Số điện thoại:</Text>
          <Text style={styles.input}>{preorderDetail.phone}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Ngày đặt bàn:</Text>
          <Text style={styles.input}>{preorderDetail.date}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Thời gian đặt:</Text>
          <Text style={styles.input}>{preorderDetail.time}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Số khách:</Text>
          <Text style={styles.input}>{preorderDetail.guests}</Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={async () => {
              ...
              Alert.alert('Thông báo', 'Hủy đặt trước bàn thành công')
              try {
